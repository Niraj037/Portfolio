  ...
  return (
    <div className="p-6 h-full overflow-auto">
      <div className="bg-white border-2 border-gray-400 shadow-md p-6 mb-6">
        <h2 className="text-2xl font-bold mb-4 text-blue-800 border-b-2 border-blue-800 pb-2">About Nirajj</h2>
        <div className="flex flex-col md:flex-row gap-6">
          <div className="md:w-1/3">
            <div className="bg-gray-100 p-2 border border-gray-400 shadow-md">
              <img src="/hl.jpg?height=300&width=300" alt="Nirajj" className="w-full h-auto" />
            </div>
          </div>
